...
# Users Table
try:
    db_cursor.execute("CREATE TABLE users (name VARCHAR(255) NOT NULL, id VARCHAR(255) NOT NULL UNIQUE, pw VARCHAR(32) NOT NULL, registration_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP)")
